...
import com.example.baseapp.fragments.CustomFragment.customCallFragment.CustomCallRingingFragment
...
class CustomcallReciver  : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {

        if(CustomCallRingingFragment.checkring==false){
            Log.d("TestTag","InsideOnReceiver of Custom Call")
            ...
            Log.d("Testtag","Number in Reciver $profileInt")
